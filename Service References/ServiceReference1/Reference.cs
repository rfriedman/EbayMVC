...
namespace EbayMVC.ServiceReference1 {
    ...
    public interface IEbayClient {
        ...
        EbayMVC.ServiceReference1.cat_count[] GetCategoryCount();
        ...
        EbayMVC.ServiceReference1.tblItem[] FindByKeyWord(string items);
    }
    ...
    public partial class EbayClientClient : System.ServiceModel.ClientBase<EbayMVC.ServiceReference1.IEbayClient>, EbayMVC.ServiceReference1.IEbayClient {
        ...
        public EbayMVC.ServiceReference1.cat_count[] GetCategoryCount() {
            return base.Channel.GetCategoryCount();
        }
        
        public EbayMVC.ServiceReference1.tblItem[] FindByKeyWord(string items) {
